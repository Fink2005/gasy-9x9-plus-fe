...
'use client';
import type { ProfileFormData } from '@/app/schema/numberology';
import { profileSchema } from '@/app/schema/numberology';
...
const ProfileForm = () => {
  ...
  const onSubmit = (data: ProfileFormData) => {
    console.log(data);
    router.push('/numberology/result');
    reset();
  };
