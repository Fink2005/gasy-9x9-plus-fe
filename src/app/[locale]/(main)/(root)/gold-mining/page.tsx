  ...
  return (
    <div className="pt-10 bg-gold-mining min-h-screen flex flex-col items-center">
      <div className="z-0">
        ...
        <Image width={500} height={500} quality={100} className="w-[12.125rem] h-[10.9136rem] absolute inset-1/2 -translate-1/2 animateLand" alt="Mining robot" src="/assets/mining-robot.webp" />
      </div>
      <GoldMining address={address} />
    </div>
  );
};
